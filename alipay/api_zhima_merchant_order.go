...
type MiniProgramCreditBorrowParams struct {
	...
	BorrowTime      common.JsonTime `json:"borrow_time,omitempty"`
	ExpiryTime      common.JsonTime `json:"expiry_time,omitempty"`
...
func (c *Client) BuildMiniProgramCreditBorrowParams(outOrderNo, goodsName string,
	...
	return &MiniProgramCreditBorrowParams{
		...
		InvokeType:      "TINYAPP",
		CreditBiz:       creditBiz,
		BorrowTime:      common.JsonTime(borrowTime),
		ExpiryTime:      common.JsonTime(expiryTime),
	}
}
